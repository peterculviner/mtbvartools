...
parser = argparse.ArgumentParser(
    description='Runs Breseq in polymorphism mode.',
...
base_dir = f'{args.dir}/{args.output}/breseq_polymorphism/'
...
if is_paired:
    cmd = f'\
        breseq --brief-html-output --polymorphism-prediction \
        -n {args.output} \
        -o {base_dir} \
        -j {args.threads} \
        -r {args.genbank} \
...
stats_keys = [
    ['breseq_polymorphism_snp_count', '-m2 -M2 -v snps'],]
